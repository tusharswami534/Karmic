          ...
          <a href='#home' className='absolute left-1/2 -translate-x-1/2 bottom-[10%] max-lg:bottom-0'><HeroArrow/></a>
            <div className='max-w-[1122px] w-full gap-y-5 max-lg:py-[60px] flex mx-auto max-lg:flex-wrap'>
                <div className='w-7/12 max-lg:w-full'>
                  ...
                  <p className='font-normal text-base leading-[28.8px] lg:max-w-[570px] text-white pt-[13px] max-md:text-sm max-lg:text-center'>Vulputate tristique habitant neque, accumsan. Vitae ultrices nulla erat nibh aliquam, quis tempus volutpat arcu. Leo convallis luctus dis malesuada turpis non consequat ac. </p>
                  <div className='flex gap-8 max-lg:gap-6 max-md:gap-4 pt-10 max-lg:pt-8 max-md:pt-5 max-lg:justify-center'>
                ...
                <div className='w-5/12 max-lg:w-full flex justify-end max-lg:justify-center'>
                  <img className='max-w-[398px] max-md:w-full' src={HeroImage} alt="hero-image" />
                </div>
            </div>
        </div>
    </>
